...
<div class="white-box">
    <h2>Imprint</h2>
    <p>As this site is hosted and made in germany 
       the law enforces us to have a so called "Impressum" Page in german language.</p>
	...
	91083 Baiersdorf<br />
	<br />
	Mail: webmaster@coffeestats.org<br />
	Jabber: noqqe@jabber.ccc.de<br />
	...
	Betreiber erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere 
	...
	an Dritte weitergegeben. <br/> Wir weisen darauf hin, dass die Datenübertragung im 
	...
	<br/>
	<br/>
	<br />Quelle: <i>Erstellt durch den <a href="http://www.e-recht24.de">Impressum-Generator</a> von e-recht24.de für Privatpersonen.</i>
	</p>
</div>
<?php
include('footer.php');
